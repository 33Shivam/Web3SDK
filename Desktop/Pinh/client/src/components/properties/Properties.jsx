...
//             <option value="1">UNACEDMY</option>
//             <option value="2">PHYSICSWAALLAH</option>
...
//             <div className={classes.properties}>
//               {filteredProperties.map((property) => (
//                 <div key='643db076de4b7651cb65434d' className={classes.property}>
//                   <Link  className={classes.imgContainer} to={`/propertyDetail/643db076de4b7651cb65434d`}>
